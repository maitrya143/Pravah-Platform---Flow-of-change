...
import { Search, Download, ArrowLeft, CreditCard, User as UserIcon, PenTool, Database, Save, CheckCircle } from 'lucide-react';
...
export const StudentQR: React.FC<StudentQRProps> = ({ user }) => {
  ...
  const handleManualSubmit = (e: React.FormEvent) => {
      ...
      // Upsert: Add or Update student in database
