...
import { Download, CheckCircle, ArrowLeft, Upload, FileText } from 'lucide-react';
...
export const Admission: React.FC<AdmissionProps> = ({ user }) => {
  ...
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
      if (e.target.files && e.target.files[0]) {
          ...
          // For prototype, we store the name. In production, this would be an upload URL or Base64
